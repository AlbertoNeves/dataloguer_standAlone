...
void UI_Update()
{
    ...
    case ST_LOGGING:
        ...
        case ST_CALIBRATION:
    ScreenCalibration_Handle(evt);
    handled = true;
    break;

    case ST_GRAPH_CALENDAR:
        ScreenGraphCalendar_Handle(evt);
        handled = true;
        break;

    case ST_GRAPH_VARIABLE:
        ScreenGraphVar_Handle(evt);
        handled = true;
        break;
    ...
    // evento global BACK
     if (!handled && evt == EVT_LEFT && System_GetState() == ST_HOME)
    {
